package com.example.pr_22_gladunov
 ...
 * Use the [CountPressFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class CountPressFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_count_press, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment CountPressFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CountPressFragment().apply {
